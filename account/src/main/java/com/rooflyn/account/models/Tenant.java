...
import com.rooflyn.account.models.enums.*;
...
public class Tenant extends User{
    ...
    public Tenant(String username, String email, String password, String phoneNumber, LocalDate dateOfBirth, UserStatus userStatus, boolean emailVerified,
